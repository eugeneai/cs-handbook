...
\usepackage[handbook,times,fancybot,inconsolata,smalltitles,microtyping]{subook}
\usepackage{xcolor}
...
\e{Здесь про использование в курсовых и дипломных, магистерских и
  вырабатывание привычки всегда думать немного вперед. Про два вида
  программ: понятные и быстрые (Непейвода).}
